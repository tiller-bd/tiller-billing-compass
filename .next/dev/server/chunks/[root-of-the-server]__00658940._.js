...
async function GET(request) {
    try {
        ...
        const clients = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].client.findMany({
            where: {
                OR: [
                    {
                        name: {
        ...
        const transformed = clients.map((client)=>{
            ...
            const totalReceived = client.projects.flatMap((p)=>p.bills).reduce((sum, b)=>sum + Number(b.receivedAmount || 0), 0);
            return {
                ...client,
...
async function POST(request) {
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].client.create({
            data: {
                name,
                contactPerson,
                contactEmail,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00658940._.js.map