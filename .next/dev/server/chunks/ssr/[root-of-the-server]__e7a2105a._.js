...
"[project]/src/data/clients.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/data/departments.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/data/api.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/clients.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$departments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/departments.ts [app-ssr] (ecmascript)");
...
async function fetchUsers() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usersData"]
    ];
}
async function validateLogin(email, password) {
    await delay(200);
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usersData"].find((u)=>u.email.toLowerCase() === email.toLowerCase());
    if (!user) {
        return {
            success: false,
    ...
    const correctPassword = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userPasswords"][user.email];
...
async function createUser(userData) {
    ...
    const newUser = {
        ...userData,
        id: String(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usersData"].length + 1),
        createdAt: new Date()
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usersData"].push(newUser);
    return newUser;
}
async function fetchProjects() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"]
    ];
}
async function createProject(projectData) {
    ...
    const newProject = {
        ...projectData,
        id: String(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"].length + 1),
        createdAt: new Date(),
        phases: [],
        bills: []
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"].push(newProject);
    return newProject;
}
async function updateProject(id, updates) {
    await delay(200);
    const index = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"].findIndex((p)=>p.id === id);
    if (index === -1) return null;
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"][index] = {
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"][index],
        ...updates
    };
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"][index];
}
async function fetchBills() {
    await delay(100);
    const bills = [];
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"].forEach((project)=>{
...
async function createBill(projectId, billData) {
    await delay(200);
    const project = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["projectsData"].find((p)=>p.id === projectId);
...
async function fetchClients() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clientsData"]
    ];
}
async function createClient(clientData) {
    ...
    const newClient = {
        ...clientData,
        id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clientsData"].length + 1
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clientsData"].push(newClient);
    return newClient;
}
async function fetchDepartments() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$departments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["departmentsData"]
    ];
}
async function fetchCategories() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categoriesData"]
    ];
}
}),
...
function AuthProvider({ children }) {
    ...
    const handleActivity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (!isLocked) {
    ...
    const login = async (email, password)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateLogin"])(email, password);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e7a2105a._.js.map