...
"[project]/src/data/clients.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/data/departments.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/data/api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/clients.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$departments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/departments.ts [app-client] (ecmascript)");
...
async function fetchUsers() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersData"]
    ];
}
async function validateLogin(email, password) {
    await delay(200);
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersData"].find((u)=>u.email.toLowerCase() === email.toLowerCase());
    if (!user) {
        return {
            success: false,
    ...
    const correctPassword = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userPasswords"][user.email];
...
async function createUser(userData) {
    ...
    const newUser = {
        ...userData,
        id: String(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersData"].length + 1),
        createdAt: new Date()
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersData"].push(newUser);
    return newUser;
}
async function fetchProjects() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"]
    ];
}
async function createProject(projectData) {
    ...
    const newProject = {
        ...projectData,
        id: String(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"].length + 1),
        createdAt: new Date(),
        phases: [],
        bills: []
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"].push(newProject);
    return newProject;
}
async function updateProject(id, updates) {
    await delay(200);
    const index = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"].findIndex((p)=>p.id === id);
    if (index === -1) return null;
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"][index] = {
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"][index],
        ...updates
    };
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"][index];
}
async function fetchBills() {
    await delay(100);
    const bills = [];
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"].forEach((project)=>{
...
async function createBill(projectId, billData) {
    await delay(200);
    const project = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsData"].find((p)=>p.id === projectId);
...
async function fetchClients() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clientsData"]
    ];
}
async function createClient(clientData) {
    ...
    const newClient = {
        ...clientData,
        id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clientsData"].length + 1
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$clients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clientsData"].push(newClient);
    return newClient;
}
async function fetchDepartments() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$departments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["departmentsData"]
    ];
}
async function fetchCategories() {
    await delay(100);
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categoriesData"]
    ];
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
function AuthProvider({ children }) {
    ...
    const handleActivity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[handleActivity]": ()=>{
            if (!isLocked) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            events.forEach({
                "AuthProvider.useEffect": (event)=>window.addEventListener(event, handleActivity)
            }["AuthProvider.useEffect"]);
            return ({
                "AuthProvider.useEffect": ()=>events.forEach({
                        "AuthProvider.useEffect": (event)=>window.removeEventListener(event, handleActivity)
                    }["AuthProvider.useEffect"])
            })["AuthProvider.useEffect"];
        }
    }["AuthProvider.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const checkIdle = setInterval({
                "AuthProvider.useEffect.checkIdle": ()=>{
                    if (Date.now() - lastActivity > IDLE_TIMEOUT) {
                        setIsLocked(true);
                    }
                }
            }["AuthProvider.useEffect.checkIdle"], 1000);
            return ({
                "AuthProvider.useEffect": ()=>clearInterval(checkIdle)
            })["AuthProvider.useEffect"];
        }
    }["AuthProvider.useEffect"], [
        user,
    ...
    const login = async (email, password)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateLogin"])(email, password);
...
_s(AuthProvider, "BEx5z6R8kfTRjowz+cxTB9siTgk=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1424f977._.js.map